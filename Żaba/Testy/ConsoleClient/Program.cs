...
namespace ConsoleClient
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            LogIn("han@solo.com", "hansolo", osoba, myHub);
            Thread.Sleep(5000);
        ...
        static void TimeEstimation(Guid id, Person osoba, IHubProxy hub)
        {
            try
            {
                ...
                hub.Invoke<string>("estimateTime", id.ToString()).ContinueWith(task =>
             {
                ...
                {
                    Console.WriteLine("hello time estimation:        {0}      count: {1}", param, param2);
                });
            }
            catch (Exception e)
            {
        ...
        static void DeleteUser(Guid id, Person osoba, IHubProxy hub)
        {
            ...
            hub.On<string>("removedFromQueue", param =>
            {

                Console.WriteLine("usunieto, ID:        {0}      type: {1}", param, param.GetType());
            });
        }
